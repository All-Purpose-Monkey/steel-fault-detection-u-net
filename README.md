...
3. and used a combined loss function (focal loss + custom Dice Loss) in unet5_8 (I learned my val scores were was class dependent and vanilla Dice Loss is prone to imbalance collapse) and used an averaging apporach to the calculationg global dice loss to combat it.
